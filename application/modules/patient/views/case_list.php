            ...
            <div class=""> 
                <form role="form" action="patient/addMedicalHistory" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea id="editor1"class="form-control ckeditor" name="description" value="" rows="70" cols="70"></textarea>
                        <script>
            ...
            <div class="modal-body row">
                <form role="form" action="patient/addMedicalHistory" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="ckeditor form-control" id="editor2" name="description" value="" rows="10"></textarea>
                    </div>
