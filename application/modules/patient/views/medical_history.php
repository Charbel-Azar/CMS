...
<section id="main-content">
            ...
            <aside class="profile-nav">
                <section class="">
                    ...
                    <a href="#">
                        ...
                        <?php } else { ?>
                            <img src="uploads/icon.png" alt="Fallback Image">
                        <?php } ?>
                    </a>
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li>  <?php echo lang('insurance') ?> <span class="label pull-right r-activity"><?php echo $patient->insurance; ?></span></li>
    ...
    <div class="row">
        <?php foreach ($patient_materials as $patient_material) { ?>
            <div class="col-md-3">
                <div class="panel" style="margin-bottom: 20px; background: #f1f1f1; padding: 20px;">
                    <div class="post-info">
                        <iframe src="<?php echo $patient_material->url; ?>" style="width:100%; height:100px; border:none;"></iframe>
                    </div>
                    <div class="post-info">
                        <?php
            ...
            <div class="modal-body">
                <form role="form" action="patient/addMedicalHistory" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="">
                            <textarea id="editor1"class="ckeditor form-control" name="description" value="" rows="10"></textarea>
                            <script>
            ...
            <div class="modal-body">
                <form role="form" id="medical_historyEditForm" class="clearfix row" action="patient/addMedicalHistory" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                        <label class=""><?php echo lang('description'); ?></label>
                        <div class="">
                            <textarea class="ckeditor form-control editor" id="editor2" name="description" value="" rows="10"></textarea>
                        </div>
                    </div>
                    <input type="hidden" name="patient_id" value='<?php echo $patient->id; ?>'>
                    <input type="hidden" name="id" value=''>
